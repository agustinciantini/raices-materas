...
export class mateCarritoService {
  /** Lista interna del carrito (no observable) */
  private _listaCarrito: mate[] = [];

  /** Observable que emite los cambios en la lista del carrito */
  public listaCarrito: BehaviorSubject<mate[]> = new BehaviorSubject<mate[]>([]);
  ...
  public productoEliminado$: Subject<mate> = new Subject<mate>();
