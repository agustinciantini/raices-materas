 ...
 */
@Component({
  selector: 'app-mate-comprar',
  standalone: false,
  templateUrl: './mate-comprar.component.html',
  styleUrls: ['./mate-comprar.component.scss']
})
export class mateComprarComponent implements OnInit {
  ...
  constructor(
    ...
    private carritoService: mateCarritoService // Servicio para gestionar el carrito
  ) {}
