 ...
 */
@Component({
  selector: 'app-mate-carrito',
  standalone: false,
  templateUrl: './mate-carrito.component.html',
  styleUrls: ['./mate-carrito.component.scss']
})
export class mateCarritoComponent implements OnInit {
  /** Lista observable de productos en el carrito */
  carroLista$: Observable<mate[]>;
  ...
  constructor(
    private carrito: mateCarritoService, // Servicio para gestionar el carrito
   ...
   */
  eliminarProducto(producto: mate): void {
